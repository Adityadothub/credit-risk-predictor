...
st.write(
    "Categorical inputs are converted into numerical values for the model."
)
...
st.write(
    "Unskilled → 0 | Skilled → 1 | Highly Skilled → 2 | Management → 3"
)

st.subheader("Purpose")
st.write(
    "Business → 0 | Car → 1 | Appliances → 2 | Education → 3 | "
    "Furniture → 4 | Electronics → 5 | Repairs → 6 | Other → 7"
)
...
st.warning("""
This model provides an estimated risk score and should not be used as the sole
