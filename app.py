...
st.info(
    "Inspired by a credit card delinquency analysis simulation completed on Forage. "
    "This project adapts key risk factors and extends them into a machine learning-based "
...
st.write("""
This current version uses a pre-trained machine learning model, where predictions
are made based on user-provided inputs.
""")
...
st.write("""
**Stage 1:** Introduce user-level interaction by assigning a unique ID to each
prediction, allowing users to track and revisit their results.

**Stage 2:** Integrate a database system to store user inputs and predictions,
enabling persistent data storage and retrieval for a more scalable application.
""")